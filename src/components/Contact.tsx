...
export function Contact         (){
  ...
  const sendEmail = (event :FormEvent<HTMLFormElement>) => {
    ...
    const contacts = [
        {
          name: "WhatsApp",
          description: "+55 41 98904-6600",
          link: "https://wa.me/5512982041640?text=Olá...",
          icon: <FaWhatsapp className="h-10 w-10" />,
        },
        {
          name: "Email",
          description: "gui.conci@hotmail.com",
          link: "gui.conci@hotmail.com",
        ...
        <div className="flex flex-col gap-6 md:flex-row">
          ...
          <form ref={form} onSubmit={sendEmail} >
              ...
              <div>
                   <button
                   type="submit"
                   className="button flex items-center gap-2 font-white text-white-700"
                   disabled={loading}
                   >
