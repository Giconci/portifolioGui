...
export function Projects (){
    const projects = [
        {
          title: "Projeto 1",
          description: "Login Local storage",
          image:
            "Captura de tela 2023-07-26 082548.png",
          link: "#",
          colSpan: "col-span-1",
        },
        {
          title: "Projeto 2",
          description: "Cadastro Local storage",
          image:
            "Captura de tela 2023-07-26 082825.png",
          link: "#",
          colSpan: "col-span-1 md:col-span-2",
        },
        {
          title: "Projeto 3",
          description: "Carrosel com projetos",
          image:
            "Carrosel.png",
          link: "#",
          colSpan: "col-span-1",
