...
const educations = [
    {
      name: "Curso de Desenvolvimento Web  | Udemy",
    },
    {
      name: "Curso de React | Udemy",
    },
  ]
        ...
        <div className="flex flex-col gap-8 md:flex-row">
          <div className="basis-1/2">
            <h3 className="mb-4 flex items-center gap-2 text-lg font-extrabold text-gray-700">
              <HiAcademicCap className="h-8 w-8 text-orange-600" />
              Educação
            </h3>
          ...
          <div className="basis-1/2">
            <h3 className="mb-4 flex items-center gap-2 text-lg font-extrabold text-gray-700">
              <HiCodeBracketSquare className="h-8 w-8 text-gray-600" />
              Skills
            </h3>
